...
<body>
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
      ...
      <a class="mr-5 hover:text-white" href="updatestudentprofile.html">Update Profile</a>
      <a class="mr-5 hover:text-white" href="selectmentor.html">Select Mentor</a>
      <a class="mr-5 hover:text-white" href="addproject.html">Add Project</a>
    ...
    <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-white lg:items-center lg:justify-center mb-4 md:mb-0" href="#">
      ...
      <span class="ml-3 text-xl xl:block lg:hidden">APMS - Student</span>
    </a>
...
<img src="/img/studenthome.jpg" alt="Student Home" width="1500px">
</html>
